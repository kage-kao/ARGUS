...
async def upload_tempshare(session: aiohttp.ClientSession, path: Path) -> str:
    ...
    try:
        ...
        form.add_field("duration", str(config.TEMPSHARE_DURATION_DAYS))
        async with session.post(
