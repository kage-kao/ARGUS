...
4. Выбери **режим сжатия** (всё через ezgif, пропорции видео сохраняются —
   ничего не растягивается):
   - **по качеству**: 🎬 High (до 720p · 1500 kbps), 📺 Medium (до 480p ·
     800 kbps), 📱 Low (до 360p · 400 kbps), 🪶 Tiny (до 240p · 200 kbps);
   - **по размеру**: 🎯 50 / 100 / 250 / 500 МБ / 1 ГБ — бот сам посчитает
     нужный битрейт из длительности записи и сожмёт под целевой размер.
